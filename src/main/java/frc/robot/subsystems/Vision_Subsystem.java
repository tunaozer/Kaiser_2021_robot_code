...
public class Vision_Subsystem extends SubsystemBase {
  ...
  public Vision_Subsystem() {
    led_driver.setInverted(true); //Inverts the output of the motor controller. LEDs, sensor phase, and limit switches will also be inverted to match the new forward/reverse directions.
  }
