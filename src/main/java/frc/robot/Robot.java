...
import edu.wpi.first.wpilibj.TimedRobot; //TimedRobot implements the IterativeRobotBase robot program framework.The TimedRobot class is intended to be subclassed by a user creating a robot program.periodic() functions from the base class are called on an interval by a Notifier instance.
...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    m_robotContainer.c.setClosedLoopControl(true);   //Set the PCM in closed loop control mode.       
